...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { descripcion: @detail.descripcion, fecha: @detail.fecha, monto: @detail.monto }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { descripcion: @detail.descripcion, fecha: @detail.fecha, monto: @detail.monto }
    assert_redirected_to detail_path(assigns(:detail))
  end
